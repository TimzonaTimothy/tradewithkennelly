!(function (NioApp, $) {
  ...
  // Updated Dark Mode Switch @since v2.0 this stores the user selected option, so it does not go out on refresh
  NioApp.ModeSwitch = function () {
    var toggle = $(".dark-switch");
    ...
    // If the theme preference is stored as "dark", add the "dark-mode" class to the body and add the "active" class to the toggle button
    if (themePreference === "dark") {
      $body.addClass("dark-mode");
      toggle.addClass("active");
  
      // Add the data field "theme" with value "dark"
